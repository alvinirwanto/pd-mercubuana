    ...
    return (
        <nav className={`${shadowNav ? 'shadow-md' : 'shadow-none'} bg-white fixed top-0 duration-300 z-[100] w-full px-4 md:px-8 xl:px-[5rem] py-4 flex justify-between items-center`}>
            ...
            <div className='flex items-center gap-[3rem]'>
                    ...
                    <div className="absolute z-10 hidden bg-grey-200 group-hover:block">
                        <div className="w-full bg-white shadow-lg">
                            <div className="flex flex-col">
                                <Link href='/keuangan/permintaan-pembayaran' className='hover:bg-gray-100 px-6 py-4'>Payment Request dan Cash Advance</Link>
                                <Link href='/keuangan/laporan-keuangan' className='hover:bg-gray-100 px-6 py-4'>Laporan Keuangan</Link>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="absolute z-10 hidden bg-grey-200 group-hover:block">
                        <div className="w-full bg-white shadow-lg">
                            <div className="flex flex-col">
                                ...
                                <Link href='/marketing/cost-per-student' className='hover:bg-gray-100 px-6 py-4'>Cost per Student</Link>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <Link href='/akreditasi/' className='w-full text-base bg-transparent rounded-lg md:w-auto md:inline md:mt-0 focus:outline-none font-semibold'>Akreditasi</Link>
                ...
                {/* <div className="hidden md:block relative group">
                   <button className="w-full text-base bg-transparent rounded-lg md:w-auto md:inline md:mt-0 focus:outline-none font-semibold">
                    ...
                    <div className="absolute z-10 hidden bg-grey-200 group-hover:block">
                        <div className="w-full bg-white shadow-lg">
                            <div className="flex flex-col">
                                <Link href='/proyek/hambalang-farm' className='hover:bg-gray-100 px-6 py-4'>Hambalang Farm</Link>
                            </div>
                        </div>
                    </div>
                </div> */}
